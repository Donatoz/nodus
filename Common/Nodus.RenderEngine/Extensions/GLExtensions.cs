...
public static class GLExtensions
{
    ...
    public static void TryThrowNextError(this GL gl, string? message = null, IRenderTracer? tracer = null)
    {
#if DEBUG
        ...
        {
            var exception = new OpenGlException($"{error.ToString()}. {message}");
